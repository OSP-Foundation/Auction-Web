...
const Page = () => {
    return (
        <main
            className='p-container md:p-container-md md:pt-[5rem] max-w-7xl w-full mx-auto'
            id='single-item'
        >
            <section
                id='left'
            ...
            >
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.064008196703!2d76.3575367683525!3d10.0115717682021!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080c9d4968ed6b%3A0xac7018beb464c0b!2sInfopark%20Kochi!5e0!3m2!1sen!2sin!4v1703670782363!5m2!1sen!2sin"
                    width="100%"
                    height="450"
                    allowFullScreen
                    loading="lazy"
                    className='rounded-md border border-primary-border mt-2'
